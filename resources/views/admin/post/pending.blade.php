                                        ...
                                        @if (!empty($posts) && count($posts) > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-sm btn-warning waves-effect" href="{{Route('admin.post.show' ,$post->id)}}"><i class="material-icons">visibility</i></a>
                                                    ...
                                                    <form class="d-none" id="delete-form-{{$post->id}}" action="{{Route('admin.post.destroy' ,$post->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </td>
